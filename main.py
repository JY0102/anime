...
if __name__ == "__main__":
    ...
    video_file = r'c:\Users\User\Desktop\원천데이터\REAL\WORD\01\NIA_SL_WORD1513_REAL01_F.mp4'  
    ...
    if original_data is not None:
        ...
        check_data = Detect_joint(original_data)
        interpolated_data = spline(check_data.frames)
